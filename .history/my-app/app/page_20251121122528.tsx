...
{/* right part of nav */}
<div  className="flex  gap-10 absolute top-10 right-10 mt-10 text-pink-600 ">
  <CiSearch className="h-8 w-10 hover:text-blue-600  text-2xl" />
  <button className=" text-white bg-pink-600 hover:bg-blue-600 font-semibold text-lg px-0.5 py-1 ">Register</button>
</div>
</nav>
