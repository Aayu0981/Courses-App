               ...
               <div className="md:mx-5">
                 ...
                 <div className="  whitespace-normal w-120 md:m-2 text-[16px] md:mx-5" >
                     <b >Gain career-advancing skills with online MBAs and Business
                      ...
                      <button className="border border-pink-600 rounded-xl text-pink-600  hover hover:text-blue-600 hover:border-blue py-[7px] px-[14px]">Explore ExperTracks</button>
                          </div>
