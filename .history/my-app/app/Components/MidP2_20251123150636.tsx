  ...
  <div className=" mx-auto md:m-5">
       ...
       <div>
        <div>
          ...
          <button className="text-lg text-white py-[8px] px-[16px] rounded-xl font-stretch-normal bg-pink-600 hover:bg-blue-600  font-sans mt-10 >View all short couses</button>
