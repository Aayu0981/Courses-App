...
<div className="md:my-40 px-10 py-10 bg-white">
  {/* TOP MENU */}
  <div className="flex flex-col text-pink-600 justify-center items-center text-[20px] font-semibold space-y-2">
    <span>Subjects</span>
  ...
  {/* TEXT BELOW (Exactly Under Span Menu) */}
  <div className="text-[16px] flex flex-col items-center gap-y-2 mt-5">
