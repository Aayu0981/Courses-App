          ...
          <div className='flex  justify-between md:py-10 -mt-5'>
            ...
            <div className=' h-120 w-130  px-10 py-10 -mt-10'>
              ...
              <div className='flex items-center -ml-5'>
                ...
                <p className='font-medium realtive'> <RiDoubleQuotesL  /> The course was beautifully conceptualised, and well presented. The
                  videos were lucid, clear, articulate and informative.<RiDoubleQuotesR />
                </p>
