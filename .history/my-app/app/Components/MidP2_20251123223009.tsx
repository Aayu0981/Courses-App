  ...
  <div className=" mx-auto md:m-5">
       ...
       <div className="flex  items-center gap-20 md:m-6">
        ...
        buttonText="Microcredential"/>
             ...
             <div className=" flex col col-2 items-center bg-gradient-to-r from-purple-100 to-pink-100 w-[90%] h-120 rounded-[90px] shadow-md shadow-gray-500 mx-auto mt-20 ">
              {/* <div className=" gap-20 justify-center  md:pt-20  "  */}
<div className="flex gap-10 bg-pink-800 mx-20 items-center w-90 ">
                  
                <div className="iteam-centre my-10">  <Image src="/image11.webp" alt="image" height={60} width={300 } className="mr-10"/>
                </div>
