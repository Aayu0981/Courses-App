...
export default function Subject() {
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <Link href="https://www.futurelearn.com/?main-nav-submenu=main-nav-courses">
        <span>Courses</span>
        </Link>
        {open ? <IoChevronUpOutline /> : <IoChevronDownSharp />}
      </div>
  ...
  <div className="flex ">
        ...
        <div className="grid grid-cols-2 gap-5 justify-between items-center font-normal">
         
          <div className="text-black animaIcone"> 
          

           <div className=" bg-white relative">

            <Image src="/image14.webp" alt="image" height={100} width={300} className=""/>
            <div className="h-20 w-72 my-3 space-y-2 ml-3">
            <p className="text-[14px] text-gray-500 ">Short Course</p>
            <p  className = "text-[15px]">Becoming a Teacher</p>
            </div>
           </div>
           </div>
           ...
           <div className="bg-white  ">
            ...
            <Image src="/image15.webp" alt="image" height={200} width={300}/>
            <div className="h-20 w-72 my-3 space-y-2 ml-3">
            <p className="text-[14px] text-gray-500 ">Short Course</p>
            <p  className = "text-[15px]">AWS Artificial Intelligence Practitioner</p>
            </div>
           </div>
           </div>
           ...
           <div className="bg-white  ">
            ...
            <Image src="/image16.webp" alt="image" height={200} width={300}/>
            <div className="h-20 w-72 my-3 space-y-2 ml-3">
            <p className="text-[14px] text-gray-500 ">Short Course</p>
            <p  className = "text-[15px]">Preparing to Study at the Masters Level: Essential Skills for Academic Success</p>
            </div>
           </div>
           </div>
           ...
           <div className="bg-white   ">
            ...
            <Image src="/image17.webp" alt="image" height={200} width={300}/>
            <div className="h-20 w-72 my-3 space-y-2 ml-3 ">
            <p className="text-[14px] text-gray-500 ">Short Course</p>
            <p className = "text-[15px]">AI for Social Professionals: Social Work, Psychology, and More</p>
            </div>
           </div>
           </div>
