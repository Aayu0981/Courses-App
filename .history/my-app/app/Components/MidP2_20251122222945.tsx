...
export default function MidPages2(){
  ...
  <div className="container mx-auto md:m-5">
        ...
        <button className="text-xl text-white py-[8] px-2 rounded-2xl font-semibold font-stretch-normal bg-pink-600 hover:bg-blue-600">Explore business degrees</button>
    </div>
