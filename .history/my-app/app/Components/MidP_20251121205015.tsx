...
export default function HeroSection() {
  return (<>
    ...
    <section className="bg-gradient-to-r from-purple-200 via-pink-200 to-orange-100 min-h-screen w-full  mt-10">
...
<div><div className='bg-amber-600 rounded-2xl  mt-30 h-screen w-full -mt-20  ' > hii</div></div>
    </section>
