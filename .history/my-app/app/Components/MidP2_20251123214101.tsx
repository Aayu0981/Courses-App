                  ...
                  <div className="flex col col-2 gap-30 md:px-20 " >
                   ...
                   <Image src="/image4.jpg" alt="image" height={200} width={500}/>
                    ...
                    <div>
                      ...
                      <p className="text-[">FutureLearn has partnered with leading CV reviewer TopCV, to hel boostyour employability and enable better course recommendations for you. Get 
