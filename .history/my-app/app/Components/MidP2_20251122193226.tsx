    ...
    <div className="flex items-center justify-center" >
      <span className="text-3xl font-size  ">Learn with <span className="text-pink-600">200+</span>
       world-classs institutuions<br/>
        ...
        <div> 
            <div className="flex justify-center gap-10 md:my-20 cursor-pointer shadow-md shadow-gray-500 ">
            <Image src="/kingclg.avif" alt="image" height={100} width={100}  className="hover:underline-blue-600 hover:decoration-wavy cursor-pointer "/>
              ...
              <Image src="/cam2.svg" alt="image" height={200} width={200}/>
                ...
                <Image src="/ucl2.svg" alt="image" height={200} width={200}/>
                  ...
                  <Image src="/leed2.svg" alt="image" height={200} width={200}/>
                    ...
                    <div className="flex justify-center gap-10 md:my-20">
