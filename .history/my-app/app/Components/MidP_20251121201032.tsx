...
export default function HeroSection() {
  return (<>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-pink-600 leading-tight">
              Accelerate<br/>
             <h2 className='text-blue-600 text-4xl md:text-5xl font-bold'> your learning</h1>
            </h1>
   ...
   <div className="bg-white w-3/4 md:w-1/2 lg:w-1/3  rounded-2xl shadow-2xl p-8 mx-auto"> 
