...
<div className="md:my-40 px-10 py-10 bg-white relative">
  <div className="flex gap-20 text-pink-600 justify-center text-[20px] font-semibold">
    <span>Subjects</span>
  ...
  <div className="absolute text-[16px] flex justify-center gap-20 mt-5 bg-emerald-700">
