  ...
  <div className=" mx-auto md:m-5">
        ...
        <div className="w-320 h-200 bg-white rounded-[90px]  shadow-md shadow-gray-500 md:my-25">
          <div className="px-[64px] my-[124px]">
           ...
           <h2 className="text-[40px] -mt-10 font-semibold">How does it work</h2>
                           <RxDividerHorizontal size={100} className="text-pink-600 -mt-6 -ml-3"  />


           <div className="flex gap-8 justify-center text-[16px] my-15">
            <span className="relative after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-[-10px] after:h-[3px] 
            after:w-0 after:bg-gradient-to-r after:from-pink-600
             after:to-red-300 hover:after:w-full after:transition-all after:duration-300 cursor-pointer ">Short courses</span>
             <span className="hover-underline-gradient">ExpertTracks</span>
