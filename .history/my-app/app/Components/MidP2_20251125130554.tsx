...
<div className="md:my-40 px-10 py-10 bg-white">
  ...
  <div className="flex flex-col justify-center items-center text-[18px] text-pink-600 font-semibold space-y-4">

    {/* ITEM 1 */}
    <div className="flex flex-col items-center">
      <span>Subjects</span>
      <p className="text-[14px] text-black">Courses grouped by subject</p>
    </div>

    {/* ITEM 2 */}
    <div className="flex flex-col items-center">
      <span>Short courses</span>
      <p className="text-[14px] text-black">Learn new skills with a flexible online course</p>
    </div>

    {/* ITEM 3 */}
    <div className="flex flex-col items-center">
      <span>ExpertTracks</span>
      <p className="text-[14px] text-black">Upskill with a series of specialist courses</p>
    </div>

    {/* ITEM 4 */}
    <div className="flex flex-col items-center">
      <span>Microcredentials</span>
      <p className="text-[14px] text-black">Earn professional or academic accreditation</p>
    </div>

    {/* ITEM 5 */}
    <div className="flex flex-col items-center">
      <span>Online degrees</span>
      <p className="text-[14px] text-black">Study flexibly online as you build to a degree</p>
    </div>
