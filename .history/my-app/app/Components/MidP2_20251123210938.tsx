...
<div className="flex justify-center items-center bg-gradient-to-r from-purple-100 to-pink-100 w-[200px] h-[100px] rounded-[90px] shadow-md shadow-gray-500 mx-auto">
