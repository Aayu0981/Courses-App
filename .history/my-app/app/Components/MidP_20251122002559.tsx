        ...
        <div className='flex items-center'> 
            ...
            <div>
                <div className='bg-amber-400 h-100 w-70 rounded-3xl shadow-md shadow-gray-500'>
                    <Image src="/image1.webp" alt='image' width={200} height={100} className='w-full h-40 object-cover overflow-hidden'/>

                    <h2 className='mx-4 my-4'>Finace, Investment and Banking(Online),BSc(Hons)</h2>
                    <p>Step into the world of finance ready
                      with practical skills, industry insigh
                    </p>
