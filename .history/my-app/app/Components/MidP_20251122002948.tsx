        ...
        <div className='flex items-center'> 
            ...
            <div>
                <div className='bg-amber-400 h-100 w-70 rounded-3xl shadow-md shadow-gray-500'>
                    <Image src="/image1.webp" alt='image' width={200} height={100} className='w-full h-30 object-cover overflow-hidden'/>

                    <h2 className='mx-4 my-4 fo'>Finace, Investment and Banking(Online),BSc(Hons)</h2>
                    ...
                    <button className='mx-4 bg-gray-500 p-1 rounded-xl font-semibold'>Degree Program</button>
