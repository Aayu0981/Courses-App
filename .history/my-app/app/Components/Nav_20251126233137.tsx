...
//         {/* Navbar Items */}
//         <div className="flex items-center gap-6 text-pink-600 font-semibold">
  ...
  return (
    <div className="relative"> {/* important */}
      <div
        ...
        className="flex items-center cursor-pointer select-none text-pink-600 hover:text-blue-600 text-xl gap-1"
      >
        <span>Subjects</span>
      ...
      {open && (
        <div className="absolute left-0 top-full bg-gray-100 w-72 shadow-lg rounded-md p-4 z-50">
          {/* dropdown content */}
          <p className="hover:text-blue-600 cursor-pointer">Computer Science</p>
          <p className="hover:text-blue-600 cursor-pointer">Business & Management</p>
          <p className="hover:text-blue-600 cursor-pointer">Data Analytics</p>
          <p className="hover:text-blue-600 cursor-pointer">Healthcare</p>
          <p className="hover:text-blue-600 cursor-pointer">Psychology</p>
        </div>
      )}
    </div>
  );
