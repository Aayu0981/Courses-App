...
export default function MidPAges(){
    return(<div className="bg-gradient-to-r from-purple-200 to-pink-200 p-50  relative  w-full flex top-4">

        {/* left part */}
        
      <div className="absolute top-60 left-50 font-bold "></div>
      <div className="">
      ...
      {/* right part */}
      <div className="bg-amber-500 w-60 ">
        <div className=" ">
            <p className="w-50">Take you career further. Discover 1400+ courses  
