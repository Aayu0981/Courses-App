    ...
    <div className="flex items-center justify-center" >
      <span className="text-3xl font-size  ">Learn with <span className="text-pink-600">200+</span>
       world-classs institutuions<br/>
        ...
        <div> 
            <div className="flex justify-center gap-10 md:my-20 cursor-p ">
            <Image src="/kingclg.avif" alt="image" height={100} width={100}  className="hover:border-blue-600 cursor-pointer "/>
