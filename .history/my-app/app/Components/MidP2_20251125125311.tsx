...
<div className="md:my-40 px-10 py-10 bg-white justify-center ">
  <div className="felx flex-col gap-20 text-pink-600 justify-center text-[20px] font-semibold">
    <span>Subjects</span>
  ...
  <div className=" absolut text-[16px] flex justify-center gap-20 mt-5 bg-emerald-700">
        <p>Courses grouped by subject</p>
     <p>learnnew skills with a 
      flexible online course
     </p>
      <p>Upskill with a series of 
        specialiist courses
      </p>
       <p>Earn professional or academic
        accreditation
       </p>
       <p >Study flexibly online as you 
        build to a degree 
       </p>
  </div>
</div>
