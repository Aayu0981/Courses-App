...
export default function MidPages2(){
  ...
  <div className=" mx-auto md:m-5">
        ...
        <button className="text-lg text-white py-[8px] px-[16px] rounded-xl font-stretch-normal bg-pink-600 hover:bg-blue-600  font-sansmt-10">Explore business degrees</button>
    </div>
