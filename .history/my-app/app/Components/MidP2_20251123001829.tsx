...
export default function MidPages2(){
  ...
  <div className=" mx-auto md:m-5">
        ...
        <div className="w-320 h-200 bg-white rounded-[90px]  shadow-md shadow-gray-500 md:my-25">
          <div className="px-[64px] my-[124px]">
           {/* heading aytehi yha */}

           <div className="flex gap-8 justify-center text-[16px]">
            <span>Short courses</span>
             <span>ExpertTracks</span>
              <span>Microcredentials</span>
               <span>Online degrees</span>
           </div>

           <div className="flex grid grid-cols-4 gap-5 my-[100px]">
            <div className="flex-col grid gap-10 bg-amber-500 ">
              <h1>1</h1>
              <span className="text-[25px]">Choose a short course</span>
              <p className="text-[16px]">From introductory to advanced, you'll find
            ...
            <div className="flex-col grid gap-10 bg-amber-500 ">
              <h1>2</h1>
              <span className="text-[25px]">Apply to study with a world-class university</span>
              <p className="text-[16px]">Like the look of a degree? Request more
                 info by filling in our form or click ‘Apply now’ to apply
                  via the university’s own systems.
              </p>
            </div>
            ...
            <div className="flex-col grid gap-10 bg-amber-500 ">
              <h1>3</h1>
              <span className="text-[25px]">Choose a short course</span>
              <p className="text-[16px]">Work through your degree in your own time, whenever and wherever suits you. All you need is access to the internet and a device to learn on.
              </p>
            </div>
            ...
            <div className="flex-col grid gap-10 bg-amber-500 ">
              <h1>1</h1>
              <span className="text-[25px]">Choose a short course</span>
              <p className="text-[16px]">Now you’ve caught the bug, what will you learn next?
            </div>
