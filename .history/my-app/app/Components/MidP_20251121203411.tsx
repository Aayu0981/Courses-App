...
export default function HeroSection() {
  return (<>
    ...
    <section className="bg-gradient-to-r from-purple-200 via-pink-200 to-orange-100 min-h-screen w-full pt-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          {/* (Text and Rating) */}
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-pink-600 leading-tight mt-20">
              Accelerate<br/>
             <p className='text-blue-600 text-4xl md:text-5xl font-bold'> your learning</p>
            </h1>
...
<div><div className='bg-amber-600 rounded-2xl  mt-30 h-screen w-full  ' > hii</div></div>
    </section>
