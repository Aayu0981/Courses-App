...
//                 <p className='mx-4'>Step into the world of finance ready
      ...
      <section className="bg-gradient-to-r from-purple-100 via-pink-200 to-orange-100 min-h-screen w-full mt-10">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            {/* Left Section */}
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-pink-600 leading-tight my-10">
                Accelerate
                <br />
                <span className="text-blue-600">your learning</span>
              </h1>

              <p className="text-3xl font-semibold">4.57 average rating</p>

              <div className="flex items-center mt-2">
                {[...Array(5)].map((_, i) => (
                  <StarIcon key={i} className="w-5 h-5 text-pink-600" />
                ))}
                <span className="ml-2 text-sm text-purple-800">1,97,142 learner reviews</span>
              </div>
            ...
            <div className="pt-4 md:pt-0">
              <p className="text-lg text-gray-700 leading-relaxed">
                Take your career further. Discover 1400+ courses
                from top universities and master in-demand skills
                across marketing, tech, business, cybersecurity and more.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <button className="bg-pink-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-md shadow-lg transition">
                  Get Unlimited learning
                </button>
                <button className="bg-white border border-gray-400 hover:text-blue-700 hover:border-blue-700 text-purple-800 font-semibold py-3 px-6 rounded-md transition">
                  Explore courses
                </button>
              </div>
            </div>
        ...
        {/* White Section */}
        <div className="bg-white rounded-[40px] shadow-lg min-h-screen mt-10 p-6 md:p-10">
          
          {/* Subject Titles */}
          <div className="text-center py-10">
            <span className="text-2xl font-semibold">Explore top subjects</span>
          </div>

          {/* Subject Icons Row */}
          <div className="flex flex-wrap justify-center gap-6 text-base cursor-pointer">
            
            {[
              { icon: <PiBookOpenTextLight className="text-pink-600 h-7 w-7" />, text: "Business & Management" },
              { icon: <BsHeartPulse className="text-pink-600 h-7 w-7" />, text: "Healthcare & Medicine" },
              { icon: <PiGraduationCapLight className="text-pink-600 h-7 w-7" />, text: "Teaching" },
              { icon: <MdTouchApp className="text-pink-600 h-7 w-7" />, text: "Tech & IT" },
              { icon: <RiMentalHealthLine className="text-pink-600 h-7 w-7" />, text: "Psychology & Mental Health" },
              { icon: <MdOutlineEngineering className="text-pink-600 h-7 w-7" />, text: "Science, Engineering & Math" },
            ].map((item, index) => (
              <div
                key={index}
                className="flex items-center gap-2 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-[-8px] after:h-[3px] after:w-0 after:bg-gradient-to-r after:from-pink-600 after:to-red-300 hover:after:w-full after:transition-all after:duration-300"
              >
                {item.icon}
          ...
          <div className="grid md:grid-cols-2 gap-12 mt-10">
            ...
            <div>
              ...
              <p className="font-medium mb-4">
                Boss it in business with our specialist upscaling courses,
                industry certifications, and high-flying degrees.
              </p>

              <p className="font-medium mb-6">
                No matter what your goals are, experts from Accenture, AWS, and
                Deakin University will guide you to achieve them. Start learning from the best.
              </p>

              <div className="flex items-start gap-3">
                <PiLineVerticalLight className="text-pink-600 text-[120px]" />

                <p className="relative font-medium leading-relaxed">
                  <RiDoubleQuotesL className="absolute -left-5 top-0 text-lg text-gray-500" />
                    The course was beautifully conceptualised, and well presented.
                    The videos were lucid, clear, articulate and informative.
                  <RiDoubleQuotesR className="absolute -right-5 bottom-0 text-lg text-gray-500" />
                </p>
              </div>

              <button className="mt-6 bg-pink-600 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded-xl">
                Explore Courses
              </button>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-center">
              ...
              {/* Card 1 */}
              <div className="w-full md:w-1/2 rounded-3xl shadow-md hover:bg-gray-100 overflow-hidden">
                <div className="relative w-full">
                  <Image src="/image1.webp" alt="image1" width={400} height={250} className="w-full h-40 object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-b from-pink-600/70 to-transparent"></div>
                </div>
                <h2 className="mx-4 mt-4 font-semibold">Finance, Investment & Banking (Online), BSc (Hons)</h2>
                <p className="mx-4 text-sm mt-2">
                  Step into the world of finance with practical skills, industry insights,
                  and recognition from a top university.
                </p>
                <button className="mx-4 my-4 bg-gray-200 px-3 py-1 rounded-xl font-medium">Degree Program</button>
              </div>

              {/* Card 2 */}
              <div className="w-full md:w-1/2 rounded-3xl shadow-md hover:bg-gray-100 overflow-hidden">
                <div className="relative w-full">
                  <Image src="/image2.jpg" alt="image2" width={400} height={250} className="w-full h-40 object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-b from-pink-600/70 to-transparent"></div>
                </div>
                <h2 className="mx-4 mt-4 font-semibold">Finance, Investment & Banking (Online), BSc (Hons)</h2>
                <p className="mx-4 text-sm mt-2">
