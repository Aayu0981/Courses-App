  ...
  <div className=" mx-auto md:m-5">
        ...
        <div className="w-320 h-200 bg-white rounded-[90px]  shadow-md shadow-gray-500 md:my-25">
          <div className="px-[64px] my-[124px]">
           ...
           <div className="flex grid grid-cols-4 gap-5 justify-center text-center  my-[100px]">
            <div className="flex-col grid gap-10 bg-amber-500 justify-center items-center ">
              <h1 className="text-[33px] font-b">1</h1>
