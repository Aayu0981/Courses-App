               ...
               <div className="md:mx-5">
                 ...
                 <div className="  whitespace-normal w-120 md:m-2 text-[16px] md:mx-5" >
                     <b >Gain career-advancing skills with online MBAs and Business
                      ...
                      <div>
                      <button className="text-lg text-white py-[7px] px-[14px] rounded-xl font-stretch-normal bg-pink-600 hover:bg-blue-600  font-sans mt-10 md:mx-5">Explore Micr</button>
