...
export default function MidPages2(){
  ...
  <div className="container mx-auto md:m-5">
        ...
        <div>
            <p> <b></b>Gain career-advancing skills with online MBAs and Business
        ...
        <button className="text-lg text-white py-[8px] px-[16px] rounded-xl font-stretch-normal bg-pink-600 hover:bg-blue-600">Explore business degrees</button>
    </div>
