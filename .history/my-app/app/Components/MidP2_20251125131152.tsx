...
<div className="md:my-40 px-10 py-10 bg-white">

  <div className="flex justify-center gap-20 text-center">

    {/* ITEM 1 */}
    <div className="flex flex-col">
      <span className="text-pink-600 text-[20px] font-semibold mb-4">Subjects</span>
      <p className="text-[14px]">Courses grouped by subject</p>
    </div>

    {/* ITEM 2 */}
    <div className="flex flex-col">
      <span className="text-pink-600 text-[20px] font-semibold">Short courses</span>
      <p className="text-[14px]">Learn new skills with a flexible online course</p>
    </div>

    {/* ITEM 3 */}
    <div className="flex flex-col">
      <span className="text-pink-600 text-[20px] font-semibold">ExpertTracks</span>
      <p className="text-[14px]">Upskill with a series of specialist courses</p>
    </div>

    {/* ITEM 4 */}
    <div className="flex flex-col">
      <span className="text-pink-600 text-[20px] font-semibold">Microcredentials</span>
      <p className="text-[14px]">Earn professional or academic accreditation</p>
    </div>

    {/* ITEM 5 */}
    <div className="flex flex-col">
      <span className="text-pink-600 text-[20px] font-semibold">Online degrees</span>
      <p className="text-[14px]">Study flexibly online as you build to a degree</p>
    </div>
