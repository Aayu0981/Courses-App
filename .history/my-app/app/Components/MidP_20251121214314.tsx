...
<div>
    ...
    <div className=' bg-white rounded-[50px]   h-screen w-full -mt-10 '>
        ...
        <span className='text-2xl font-semibold ' >Explore top subjects</span> 
         ...
         <div className='flex gap-5 font-16px'>
         ...
         <div className='flex gap-2 '>
           <MdTouchApp  className='text-pink-600 h-8 w-8 '  />
            <p>Tech & IT</p>
         </div>
         ...
         <div className='flex gap-2 '>
            <RiMentalHealthLine className='text-pink-600 h-8 w-8 '  />
         ...
         <div className='flex gap-2 '>
           <MdOutlineEngineering />t className='text-pink-600 h-8 w-8 '  />
