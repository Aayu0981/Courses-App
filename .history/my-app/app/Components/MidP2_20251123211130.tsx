  ...
  <div className=" mx-auto md:m-5">
       ...
       <div className="flex  items-center gap-20 md:m-6">
        ...
        buttonText="Microcredential"/>
             ...
             <div className="flex justify-center items-center bg-gradient-to-r from-purple-100 to-pink-100 w-[300px] h-[100px] rounded-[90px] shadow-md shadow-gray-500 mx-auto">
