...
<div>
    ...
    <div className=' bg-white rounded-[50px]   h-screen w-full -mt-10 '>
        ...
        <div className='flex items-center'> 
            ...
            <div>
                <div className=' h-100 w-70 rounded-3xl shadow-md shadow-gray-500 overflow-hidden hover:bg-gray-400'>
                    <Image src="/image1.webp" alt='image' width={500} height={500} className='w-full h-30 object-cover hover:bg-gray-200 '/>
                    ...
                    <button className='mx-4 bg-gray-500 p-1 rounded-xl font-semibold mt-12'>Degree Program</button>
