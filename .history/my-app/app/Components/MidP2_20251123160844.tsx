...
export default function MidPages2(){
  ...
  <div className=" mx-auto md:m-5">
       ...
       <div>
        ...
        <button className="text-lg text-white py-[7px] px-[16px] rounded-xl font-stretch-normal bg-pink-600 hover:bg-blue-600  font-sans mt-10">Explore business degrees</button>
