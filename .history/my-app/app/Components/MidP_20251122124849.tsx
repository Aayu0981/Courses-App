...
<div>
    ...
    <div className=' bg-white rounded-[50px]   h-screen w-full -mt-10 '>
        ...
        <span className='text-2xl font-semibold m-5' >Explore top subjects</span> 
         ...
         <div className='flex  gap-15 font-16px m-5  -mt-2 cursor-pointer  '>
...
{/* 
        ...
        <div className='flex items-center justify-between md:py-10 -mt-5 bg-amber-300'> 

            <div className=' h-120 w-130  px-10 py-10 '>
            ...
            <div className='flex gap-20 mr-10 -pb-10'>
                ...
                {/* Second div */}
                 <div className=' h-100 w-70 rounded-3xl shadow-md shadow-gray-500 overflow-hidden hover:bg-gray-100'>
                    ...
                    <Image src="/image2.jpg" alt='image' width={500} height={500} className='w-full h-30 object-cover bg-gradient-to-b from-pink-300 to-pink-200  '/>
