  ...
  <div className=" mx-auto md:m-5">
       ...
       <div className="flex  items-center gap-20 md:m-6">
        ...
        buttonText="Microcredential"/>
             ...
             <div className=" items-center bg-gradient-to-r from-purple-100 to-pink-100 w-[90%] h-120 rounded-[90px] shadow-md shadow-gray-500 mx-auto mt-20 ">
              <div className="flex col col-2 gap-20 justify-center  md:pt-20 md:px-20 " >

                  
                  {/* <Image src="/image11.webp" alt="image" height={100} width={400 }/> */}
                
               <div className="w-[300px] h-[424px]">
  <Image src="/image.webp" alt="" width={300} height={424} className="w-full h-full object-cover rounded-lg" />
</div>

                    <div className="bg-amber-500 ml-40">
                      <span className="text-[40px] font-semibold block">Ready to take your CV  to the next <br/> level?
                      </span>
                           <RxDividerHorizontal size={100} className="text-pink-600 -mt-6 -ml-3"  />


                      <p className="text-[20px]">FutureLearn has partnered with leading CV reviewer TopCV, to hel boostyour employability and enable better course recommendations for you. Get 
                        your FREE CV review in two easy steps.
                      </p>

                      <button className="buttons">Submit your CV</button>
                    </div>
