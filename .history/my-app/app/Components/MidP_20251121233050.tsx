...
<div>
    ...
    <div className=' bg-white rounded-[50px]   h-screen w-full -mt-10 '>
        ...
        <div>
            ...
            <div className='bg-pink-500 h-120 w-130  m-10 px-10 py-10'>
                <h1 className='text-2xl font-bold m-8'>Business & Management</h1>
                <p className='font-medium m'> Boss it in business with our specialist upscaling courses industry 
