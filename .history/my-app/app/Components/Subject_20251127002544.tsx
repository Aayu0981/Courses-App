...
export default function Subject() {
  ...
  return (
    <div className="relative">
      ...
      <div
        onClick={() => setOpen(!open)}
        className={`flex items-center gap-1 cursor-pointer text-2xl font-semibold rounded-md
          ${open ? "bg-gray-200 text-gray-700 px-3 py-4" : "text-pink-600 hover:text-blue-700 px-3 py-2"}`}
      >
        <span>Subjects</span>
        {open ? <IoChevronUpOutline /> : <IoChevronDownSharp />}
      </div>
