        ...
        <div className="grid grid-cols-2 gap-5 justify-between items-center font-normal">
          ...
          <div className="text-black"> 
           ...
           <div className="bg-white ">
            ...
            <div className="h-20 w-72 my-3 space-y-2 ml-3">
            <p className="text-[14px] text-gray-500 ">Short Course</p>
            <p  className = "text-[16px]">Preparing to Study at the Master's Level: Essential Skills for Academic Success</p>
            </div>
           </div>
           </div>
           ...
           <div className="bg-white ">
            ...
            <div className="h-20 w-72 my-3 space-y-2 ml-3">
            <p className="text-[14px] text-gray-500 ">Short Course</p>
            <p className = "text-[16px]">AI for Social Professionals: Social Work, Psychology, and More</p>
            </div>
           </div>
           </div>
