  ...
  <div className=" mx-auto md:m-5">
       ...
       <div>
        <div>
          ...
          <div>
            <p className="text-[16px] bg-amber-400 w-[480px] md:mx-5">Explore your next career, upakill in your current role, or pursue a 
              passion with our short courses from top universities and industry 
              experts.
            </p>
          </div>

          <button className='mx-4 bg-gray-200 p-1 rounded-xl font-medium mt-12'>View all short couses</button>
