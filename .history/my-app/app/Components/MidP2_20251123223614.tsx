...
<div className="flex gap-20 bg-pink-800 mx-20 items-center  ">
                  
                <div className="iteam-centre my-10">  <Image src="/image11.webp" alt="image" height={300} width={600 } className="mr-10"/>
                </div>
