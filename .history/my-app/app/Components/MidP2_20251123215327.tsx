  ...
  <div className=" mx-auto md:m-5">
       ...
       <div className="flex  items-center gap-20 md:m-6">
        ...
        buttonText="Microcredential"/>
             ...
             <div className="flex justify-center items-center bg-gradient-to-r from-purple-100 to-pink-100 w-[80%] h-120 rounded-[90px] shadow-md shadow-gray-500 mx-auto mt-20 flex col col-2 gap-30 md:px-20">
              <div className="flex col col-2 gap-30 md:px-20 justify-center" >

                 <div className="bg-amber-600 h-50 w-50"> <Image src="/image4.jpga" alt="image" height={300} width={500 }/>
                    </div>
