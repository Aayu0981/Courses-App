...
<div className="md:my-40 px-10 py-10 bg-white justify-center ">
  <div className="felx flex-col space-x-50 text-pink-600 justify-center text-[20px] font-semibold">
    <span>Subjects</span>
  ...
  <div className="  text-[16px] flex justify-center gap-x-20 mt-5 bg-emerald-700">
