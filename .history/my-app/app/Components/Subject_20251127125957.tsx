  ...
  <div className="flex ">
        ...
        <div className="grid grid-cols-2 gap-5 justify-between items-center font-normal">
          ...
          <div className="text-black "> 
           ...
           <div className=" bg-white rea">

            <Image src="/image14.webp" alt="image" height={100} width={300} className="object-cover"/>
            <div className="h-20 w-80 my-3 space-y-2 ml-3">
           ...
           <div className="bg-white ">
            ...
            <div className="h-20 w-70 my-3 space-y-2 ml-3">
            <p className="text-[14px] text-gray-500 ">Short Course</p>
            <p>Becoming a Teacher</p>
            </div>
           </div>
