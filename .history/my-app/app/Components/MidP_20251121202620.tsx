...
export default function HeroSection() {
  return (<>
    ...
    <section className="bg-gradient-to-r from-purple-200 via-pink-200 to-orange-100 py-16 md:py-34 mt-10 p-50">
...
<div><div className='bg-amber-600 rounded-2xl py-16 md:py-54 mt-30 h-screen w-full  ' > hii</div></div>
    </section>
