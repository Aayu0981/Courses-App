...
<div>
    ...
    <div className=' bg-white rounded-[50px]   h-screen w-full -mt-10 '>
        ...
        <span className='text-2xl font-semibold m-5' >Explore top subjects</span> 
         ...
         <div className='flex  items-center gap-2 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-[-10px] after:h-[3px] after:w-0 after:bg-gradient-to-r after:from-pink-500 after:to-blue-300 hover:after:w-full after:transition-all after:duration-300'>
