...
export default function MidPages2(){
  ...
  <div className=" mx-auto md:m-5">
       ...
       <Link href="https://www.futurelearn.com/subjects/business-and-management-courses" target="blank">
        <button className="text-lg text-white py-[8px] px-[16px] rounded-xl font-stretch-normal bg-pink-600 hover:bg-blue-600  font-sans mt-10">Explore business degrees</button>
          ...
          <div className=' md:my-10 bg-white h-100 w-70 rounded-3xl shadow-md shadow-gray-500 overflow-hidden hover:bg-gray-100 '>
                          ...
                          <Link href="https://progress.futurelearn.com/degree/cranfield-university-msc-business-and-management"></Link>
       ...
       <div>
        <div>
          ...
          <Link href="https://www.futurelearn.com/courses" className="block">
          ...
          <div className="flex col-auto md:m-5 gap-30">
            ...
            {/* <Link href="/ShortCurses" className="block">
             ...
             <Link href="https://progress.futurelearn.com/degree/teesside-university-finance-investment-and-banking-online-bsc" className="block">
          <ContainerDiv  
          image="/image7.jpg"  
          title="Educating Forces Sustainable Development (ESD) in School and Universities"
          description="Explode the global challenge facing sustainable development worldwide and how to introduce them in school and HE institutions."
          buttonText="Short Course"
           />
          </Link>
                 ...
                 <div className="  whitespace-normal w-120 md:m-2 text-[16px] md:mx-5" >
                    Gain career-enhancing skills and earn a professional certificate from
                     ...
                     analyst, or an effective climate change communicator.
                      ...
                      <div>
                        <Link href="https://www.futurelearn.com/certifications/microcredentials">
                      ...
                      <Link href="https://www.futurelearn.com/experttracks">
       ...
       <div className="flex  items-center gap-20 md:m-6">
         ...
         <Link href="https://www.futurelearn.com/microcredentials/data-analytics-for-e-commerce">
        ...
        buttonText="Microcredential"/>
          ...
          <Link href="https://www.futurelearn.com/microcredentials/mmc706-od">
        ...
        buttonText="Microcredential"/>
         ...
         <Link href="https://www.futurelearn.com/microcredentials/digital-advertising-operations">
...
<div className="md:my-40 mx-20 px-10 py-10 ">
  ...
  <div className="flex gap-15 md:my-10">

{/* first */}
  <div className=" w-50 md:my-10 space-y-10 mx-3 ">
...
<br/>
  ...
  <div className=" w-50 md:my-10 space-y-10  -ml-10 ">
...
<br/>
 <div className=" w-50 md:my-10 space-y-10  ">
...
<br/>
 ...
 <div className=" w-50 md:my-10 space-y-10  ">
  ...
  <p className="hover:underline cursor-pointer">MBA Degrees </p>
      <p className="hover:underline cursor-pointer">Psychology Degrees</p>
        <p className="hover:underline cursor-pointer">Teaching Degrees</p>
          <p className="hover:underline cursor-pointer">IT & Computer Science Degrees</p>
            <p className="hover:underline cursor-pointer">Data Science Degrees</p>
              <p className="hover:underline cursor-pointer">PGCE</p>
                <p className="hover:underline cursor-pointer">Software Engineering Degrees </p>
                   <p className="hover:underline cursor-pointer">Software Degrees </p>

</div>
<br/>


 <div className=" w-50 md:my-10 space-y-10 ml-9  ">
  <p className="text-[17px] hover:underline cursor-pointer font-medium">Earn a bachelor degree online</p>
  <p className="hover:underline cursor-pointer">Bachelors DEgrees in Healthcare</p>
    <p className="hover:underline cursor-pointer">Bachelors DEgrees in Criminology</p>
      <p className="hover:underline cursor-pointer">Bachelors DEgrees in Psychology</p>
        <p className="hover:underline cursor-pointer">Bachelors DEgrees in Accounting</p>
          <p className="hover:underline cursor-pointer">Bachelors DEgrees in Economics</p>
            <p className="hover:underline cursor-pointer">Bachelors DEgrees in Finance</p>
              <p className="hover:underline cursor-pointer">Bachelors DEgrees in Project Management</p>
                <p className="hover:underline cursor-pointer">Bachelors DEgrees in Business & Management</p>
</div>
...
<hr className="-mt-60 text-pink-600"/>

<div className="flex justify-center gap-70 md:my-20 ">

<div className="flex  text-pink-600  gap-10 text-2xl ">
  {/* <FaFacebook /> */}
      <FaFacebook className="transition-all duration-300 hover:scale-125 cursor-pointer" />
<FaInstagram className="animaIcone" />
<FaTwitter className="animaIcone"/>
<FaYoutube className="animaIcone" />
<FaLinkedin  className="animaIcone"/>
</div>

 <div className=" -mt-1">
<Image src="/F2.png" alt="image" height={100} width={100}/>
</div>
