  ...
  <div className=" mx-auto md:m-5">
        ...
        <div className="w-320 h-200 bg-white rounded-[90px]  shadow-md shadow-gray-500 md:my-25">
          <div className="px-[64px] my-[124px]">
           ...
           <h2 className="text-[40px] -mt-10 font-semibold ml-10">How does it work</h2>
                           <RxDividerHorizontal size={100} className="text-pink-600 -mt-6 -ml-3"  />
           ...
           <div className="flex grid grid-cols-4 gap-5 justify-center  my-[100px]">
            <div className="flex-col grid gap-10  justify-center ">
              <h1 className="text-[53px] font-bold">1</h1>
            ...
            <div className="flex-col grid gap-10 ">
              <h1 className="text-[53px] font-bold">2</h1>
            ...
            <div className="flex-col grid gap-10  ">
              <h1  className="text-[53px] font-bold">3</h1>
            ...
            <div className="flex-col grid gap-10 ">
              <h1  className="text-[53px] font-bold">4</h1>
