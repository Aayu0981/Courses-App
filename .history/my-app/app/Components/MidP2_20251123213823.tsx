        ...
        buttonText="Microcredential"/>
             ...
             <div className="flex justify-center items-center bg-gradient-to-r from-purple-100 to-pink-100 w-[80%] h-120 rounded-[90px] shadow-md shadow-gray-500 mx-auto mt-20">
              <div className="flex justify-center items-center">
                  ...
                  <div className="flex col col-2 gap-30 md:px-20 space-y-10" >

                   <Image src="/image4.jpg" alt="image" height={300} width={500}/>
                    ...
                    <div>
                      ...
                      <p>FutureLearn has partnered with leading CV reviewer TopCV, to hel boostyour employability and enable better course recommendations for you. Get 
