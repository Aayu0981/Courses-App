...
<div>
    ...
    <div className=' bg-white rounded-[50px]   h-screen w-full -mt-10 '>
        ...
        <span className='text-2xl font-semibold m-5' >Explore top subjects</span> 
         ...
         <div className='flex  gap-15 font-16px m-5 cursor-pointer  relative after:absolute after:left-0 after:-bottom-1 
after:h-[3px] after:w-0 after:bg-gradient-to-r 
