...
export default function MidPages2(){
  ...
  <div className="container mx-auto md:m-5">
        ...
        <div>
            <p>Gain career-advancing skills with online MBAs and Business degrees. Earn your degree at a pace that suits you with our flexible, online MBAs and business and management degrees from top universities.</p>
        </div>
    </div>
