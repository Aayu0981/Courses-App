...
export default function MidPages2(){
  ...
  <div className=" mx-auto md:m-5">
       ...
       <div className="flex  items-center gap-20 md:m-6">
        ...
        <div className="flex justify-center items-center bg-gradient-to-r  from-purple-100 to-pink-100 w-200 h-100 rounded-[90px]  shadow-md shadow-gray-500">
          <div className="flex justify-center ie">
