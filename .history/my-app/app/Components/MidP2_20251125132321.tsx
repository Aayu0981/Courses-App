...
<div className="md:my-40 px-10 py-10 bg-white">
  ...
  <div className="flex justify-center gap-20 text-center">
    ...
    <div className="flex flex-col">
      ...
      <p className="text-[16px]">Study flexibly online as you build to a degree</p>
    </div>

  </div>


  <div className="bg-amber-600 w-40 md:my-10 space-y-10 hover:underline cursor-pointer">
  <p className="text-[17px] bg-pink-600">Discover our range of  courses</p>
  <p>Online Courses</p>
    <p>Online Certifications</p>
      <p>Microcredentials</p>
        <p>Online Bootcamps</p>
          <p>Online Degrees</p>
            <p>Online Master's Degrees</p>
              <p>Online Bachelor's Degrees</p>
                <p>Online Postgraduate Certificates</p>
</div>
