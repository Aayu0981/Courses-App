      ...
      <div>
        ...
        <div className=' bg-white rounded-[50px]  shadow-md shadow-gray-500  h-screen w-full -mt-10 '>
          ...
          <div className='flex  gap-15 font-16px m-5  -mt-2 cursor-pointer   '>
            <div className='flex mr-10 items-center gap-2  relative after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-[-10px] after:h-[3px] after:w-0 after:bg-gradient-to-r after:from-pink-600 after:to-red-300 hover:after:w-full after:transition-all after:duration-300  '>
