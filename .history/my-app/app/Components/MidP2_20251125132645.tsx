...
<div className="md:my-40 px-10 py-10 bg-white">
  ...
  <div className=" w-40 md:my-10 space-y-10 bg-amber-50 mx-3 ">
  <span className="text-[17px] hover:underline cursor-pointer font-">Discover our range of  courses</span>
