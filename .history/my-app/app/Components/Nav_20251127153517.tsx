...
export default function Nav() {
  return (
    <nav className=" fixed top-0 left-0 z-50 w-full bg-white px-8 py-4 shadow-md flex relative items-center justify-between">

      {/* Left Section */}
      <div className="flex items-center gap-8 text-xl relative">
        ...
        {/* Navbar Items */}
        <div className="flex items-center gap-6 text-pink-600 font-semibold top-0 text-[20px] ">

          <Subject />
          <Courses />

          <Link href="https://progress.futurelearn.com/degrees">
          <span className="cursor-pointer hover:text-blue-700 font-medium">Courses</span>
          </Link>
          

          <Link href="https://progress.futurelearn.com/degrees">
          <span className="cursor-pointer hover:text-blue-700 font-medium">Degrees</span>
          </Link>

          <Link href="https://www.futurelearn.com/promo/for-business">
          <span className="cursor-pointer hover:text-blue-700 whitespace-nowrap font-medium t">For Business</span>
          </Link>
        </div>
      </div>
