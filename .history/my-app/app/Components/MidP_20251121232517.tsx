...
<div>
    ...
    <div className=' bg-white rounded-[50px]   h-screen w-full -mt-10 '>
        ...
        <div>
            ...
            <div className='bg-pink-500 h-120 w-130'>
                <h2>Business & Management</h2>
                <p> Boss it in business with our specialist upscaling courses industry 
                    Certifications and high flying degrees
                </p>
                <p>
                    No matter what your goals are leading expert from the likes of Accenture AWS Deakin
