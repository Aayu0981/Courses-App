          ...
          <div className='flex  justify-between md:py-10 -mt-5'>
            ...
            <div className=' h-120 w-130  px-10 py-10 -mt-10'>
              ...
              <div className='flex items-center -ml-5'>
                ...
                <p className='font-medium flex'> <RiDoubleQuotesL /> The course was beautifully conceptualised, and well presented. The
                  videos were lucid, clear, articulate <p className='flex'>and informative.<RiDoubleQuotesR /></p>
                </p>
            ...
            <div className='flex gap-20 mr-10 -pb-10 mt-20'>
              <div className=' h-100 w-70 rounded-3xl shadow-md shadow-gray-500 overflow-hidden hover:bg-gray-100'>
                ...
                <div className='absolute inset-0 bg-pink-600/50 mix-blend-multiple '></div>
                 </div>
