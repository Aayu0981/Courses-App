       ...
       <div className="flex  items-center gap-20 md:m-6">
        ...
        buttonText="Microcredential"/>
             ...
             <div className=" items-center bg-gradient-to-r from-purple-100 to-pink-100 w-[80%] h-120 rounded-[90px] shadow-md shadow-gray-500 mx-auto mt-20 ">
              <div className="flex col col-2 gap-30 justify-center  md:pt-20 md:px-20 " >

                 <div className="bg-amber-600 h-50 w-70 mt-15"> 
                  <Image src="/image11.webp" alt="image" height={300} width={500 }/>
                    </div>
