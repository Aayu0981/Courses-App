...
export default function MidPages2(){
  ...
  <div className="container mx-auto md:m-5">
        <div>
        ...
        <div>
            <p>Gain career-advancing skills with online MBAs and Business
             degrees. Earn your degree at a pace that suits you with our flexible, 
             online MBAs and business and management degrees from top universities.</p>
        </div>

        <button className="text-xl text-white py-[8px] px-[16px] rounded-2xl font-semibold font-stretch-normal bg-pink-600 hover:bg-blue-600">Explore business degrees</button>
    </div>
