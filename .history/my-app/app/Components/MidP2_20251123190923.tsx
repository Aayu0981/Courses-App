            ...
            <div>
               ...
               <div className="md:mx-5">
                 ...
                 <div className="  whitespace-normal w-120 md:m-2 text-[16px] md:mx-5" >
                    Gain career-enhancing skills and earn a professional certificate from Deakin University with our online specialist courses. In just a few weeks, you can become an innovative leader, an in-demand data analyst, or an effective climate change communicator.
                 </div>
                      <div>
                      <button className="text-lg text-white py-[7px] px-[14px] rounded-xl  bg-pink-600 hover:bg-blue-600  font-sans mt-10 md:mx-5">Explore Microcredentials</button>
                      <button className="border border-pink-600 rounded-xl text-pink-600  hover hover:text-blue-600 hover:border-blue-600 py-[7px] px-[14px]">Explore ExperTracks</button>
                          </div>
