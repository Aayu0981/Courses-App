...
<div>
    ...
    <div className=' bg-white rounded-[50px]   h-screen w-full -mt-10 '>
        ...
        <div>
            ...
            <div className=' h-120 w-130  m-10 px-10 py-10 bg-amber-500'>
                ...
                <div className='flex items-center -ml-7'>
                     <PiLineVerticalLight className='text-pink-600 text-[150px]'  />
                        ...
                        <p>"The course was beautifully conceptualised, and well presented. The 
                            videos were lucid, clear, articulate and informative".
                        </p>
                    
                </div>
                <button className='bg-pink-600 p-2 text-white font-semibold rounded-3xl'>Explore Courses</button>
