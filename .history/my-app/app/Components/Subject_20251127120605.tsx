...
export default function Subject() {
  ...
  return (
      ...
      {open && (
        <div className="fixed left-0 top-20 bg-gray-100 shadow-xl p-10 z-50 w-full min-h-screen">
         ...
         <div className="text-black text-[16px] font-medium bg-amber-600 w-150 ml-20 px-30">
            ...
            <div className="flex gap-30 items-center hover:bg-gray-200 my-3">
            ...
            <div className="flex gap-30 items-centerhover:bg-gray-200 my-3">
                <p>History</p>
              <PiGreaterThanThin />
            </div>
            <div className="flex gap-30 items-center hover:bg-gray-200 my-3">
            ...
            <div className="flex gap-50 items-center justify-between hover:bg-gray-200 my-3">
                <p>Low </p>
              <PiGreaterThanThin />
            </div>
            <div className="flex gap-50 items-center hover:bg-gray-200 my-3">
                <p>Literature </p>
              <PiGreaterThanThin />
            </div>
            <div className="flex gap-50 items-center hover:bg-gray-200 my-3">
              ...
              <PiGreaterThanThin />
                ...
                <div className="flex gap-60 items-center hover:bg-gray-200 my-3">
    ...
    <div className="flex gap-70 items-center hover:bg-gray-200 my-3">
                <p>Study Skills</p>
              <PiGreaterThanThin />
            </div>
