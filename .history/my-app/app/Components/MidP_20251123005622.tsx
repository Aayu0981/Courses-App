  ...
  return (<>
    ...
    <section >
      ...
      <div>
        ...
        <div className=' bg-white rounded-[90px]  shadow-md shadow-gray-500  h-screen w-full -mt-10 '>
          ...
          <div className='flex  gap-15 font-16px m-5 ml-8 -mt-2 cursor-pointer   '>
            ...
            <div className='flex  items-center gap-2  relative after:absolute after:left-1/2 after:-translate-x-1/2 after:bottom-[-10px] after:h-[3px] after:w-'>
            ...
            <div className='flex  items-center gap-2  underline-center-hover cursor-pointer'>
          ...
          <div className='flex  justify-between md:py-10 -mt-5'>
            ...
            <div className='flex gap-20 mr-10 -pb-10 mt-20'>
              <div className=' h-100 w-70 rounded-3xl shadow-md shadow-gray-500 overflow-hidden hover:bg-gray-100'>
                ...
                <p className='mx-4 text-gray-600 text-[14px]'>Step into the world of finance ready
